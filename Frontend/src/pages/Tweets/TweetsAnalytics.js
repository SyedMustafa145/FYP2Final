...
const TweetsAnalyticsComments = ({ props }) => {
  const [TweetsAbout, setTweetsAbout] = useState(props[0]);
...
const TweetsAnalyticsChart = ({ props }) => {
...
const TweetsAnalytics = ({ props }) => {
  console.log("props in Tweets about", props[1]);
  const [TweetsAbout, setTweetsAbout] = useState(props[1]);
  ...
  console.log("Data in TweetsAnalytics", predictiondata);
        ...
        <Card>
          <CardBody>
            <h4 className="card-title mb-4">
              Tweets Analytics about your search : {TweetsAbout}
            </h4>
            {
              // check if series is not null
              series && <TweetsAnalyticsChart props={series} />
            }
...

            {
              // check if series is not null
              series && (
                <TweetsAnalyticsComments props={[TweetsAbout, DominantPercent]} />
              )
            }
          </CardBody>
        </Card>
...
export default TweetsAnalytics;
